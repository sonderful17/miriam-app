...
const CycleApp = () => {
  ...
  const calculatePhase = () => {
    ...
    if (cycleDay <= userData.profile.averagePeriodLength) {
      phase = 'Menstrual';
      phaseDay = cycleDay;
      phaseColor = 'from-plum-900 to-plum-800';
    } else if (cycleDay <= 13) {
      phase = 'Follicular';
      phaseDay = cycleDay - userData.profile.averagePeriodLength;
      phaseColor = 'from-peach-300 to-peach-400';
    } else if (cycleDay <= 16) {
      phase = 'Ovulatory';
      phaseDay = cycleDay - 13;
      phaseColor = 'from-peach-400 to-peach-600';
    } else if (cycleDay <= 23) {
      phase = 'Early Luteal';
      phaseDay = cycleDay - 16;
      phaseColor = 'from-plum-500 to-plum-600';
    } else {
      phase = 'Late Luteal';
      phaseDay = cycleDay - 23;
      phaseColor = 'from-plum-700 to-plum-800';
    }
    ...
    if (todayInputs) {
      ...
      if (sleep && sleep < 6) {
        guidance = {
          ...
          training: {
            ...guidance.training,
            message: 'Low sleep detected. Prioritise rest and gentle movement today.',
            modifier: 'Your body repairs during sleep. Without adequate rest, intense training adds stress rather than building strength.'
          },
          fasting: {
            ...guidance.fasting,
            message: 'Skip fasting today. Eat when hungry to support recovery.',
      ...
      if (stress === 'high') {
        guidance = {
          ...
          training: {
            ...guidance.training,
            message: 'High stress detected. Gentle movement like walking or yoga is best.',
            modifier: 'Cortisol is already elevated. Intense exercise adds more stress. Choose restorative movement.'
          },
          energy: {
            ...guidance.energy,
            message: 'Your nervous system needs support. Prioritise calming activities.',
            modifier: 'High cortisol can deplete neurotransmitters. Rest isn\'t lazy - it\'s essential.'
          },
          fasting: {
            ...guidance.fasting,
            message: 'Eat regularly today. Fasting adds stress when cortisol is high.',
  ...
  const phaseGuides = {
    Menstrual: {
      ...
      icon: 'new',
      color: 'from-plum-900 to-plum-800',
      cardBg: 'bg-gradient-to-br from-plum-100 to-plum-200',
      days: 'Days 1–5',
    ...
    Follicular: {
      ...
      cardBg: 'bg-gradient-to-br from-peach-50 to-peach-100',
      days: 'Days 6–13',
    ...
    Ovulatory: {
      ...
      cardBg: 'bg-gradient-to-br from-peach-100 to-peach-200',
      days: 'Days 14–16',
    ...
    'Early Luteal': {
      ...
      icon: 'waningGibbous',
      color: 'from-plum-500 to-plum-600',
      cardBg: 'bg-gradient-to-br from-plum-50 to-plum-100',
      days: 'Days 17–23',
    ...
    'Late Luteal': {
      ...
      icon: 'lastQuarter',
      color: 'from-plum-700 to-plum-800',
      cardBg: 'bg-gradient-to-br from-plum-100 to-plum-200',
      days: 'Days 24–28',
  ...
  const OnboardingWelcome = () => (
    <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 flex items-center justify-center p-6" style={{fontFamily: 'Lexend, sans-serif'}}>
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 space-y-6 border border-plum-200">
        <div className="text-center space-y-4">
          <div className="text-6xl">🌙</div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent">Welcome</h1>
          <p className="text-xl text-plum-900 leading-relaxed font-medium">
        ...
        <div className="bg-gradient-to-br from-plum-50 to-peach-50 rounded-2xl p-6 space-y-4 border border-plum-200">
          <div className="pl-4 border-l-2 border-plum-400">
            <h3 className="font-semibold text-plum-900">Privacy First</h3>
            <p className="text-sm text-plum-500">All data stays on your device, under your control</p>
          </div>
          <div className="pl-4 border-l-2 border-peach-400">
            <h3 className="font-semibold text-plum-900">Personalised Guidance</h3>
            <p className="text-sm text-plum-500">Recommendations that adapt to your unique rhythm</p>
          </div>
        </div>

        <button
          onClick={() => setCurrentStep(1)}
          className="w-full bg-plum-900 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-plum-800 hover:shadow-xl transform hover:scale-105 transition-all"
        >
          Get Started
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 flex items-center justify-center p-6" style={{fontFamily: 'Lexend, sans-serif'}}>
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 space-y-6 border border-plum-200">
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-plum-900">When did your last period start?</h2>
          <p className="text-plum-500">This helps us understand where you are in your cycle</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none text-lg"
            />
          </div>
        </div>
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex-1 bg-plum-50 text-plum-700 py-3 rounded-xl font-semibold hover:bg-plum-100 transition border border-plum-200"
          >
            Back
          </button>
          <button
            ...
            className="flex-1 bg-plum-900 text-white py-3 rounded-xl font-semibold hover:bg-plum-800 hover:shadow-xl transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Continue
          </button>
        </div>
  ...
  const OnboardingPeriodEnd = () => (
    <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 flex items-center justify-center p-6" style={{fontFamily: 'Lexend, sans-serif'}}>
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 space-y-6 border border-plum-200">
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-plum-900">When did it end?</h2>
          <p className="text-plum-500">Or approximately how long did it last?</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-peach-50 rounded-xl p-4 border border-peach-200">
            <p className="text-sm text-plum-700 italic">
  ...
  const OnboardingCycleLength = () => (
    <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 flex items-center justify-center p-6" style={{fontFamily: 'Lexend, sans-serif'}}>
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 space-y-6 border border-plum-200">
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-plum-900">About your cycle</h2>
          <p className="text-plum-500">Help us understand your typical rhythm</p>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none text-lg"
            />
            <p className="text-sm text-plum-400 mt-1">From first day of period to first day of next period (typically 21-35 days)</p>
          </div>

          <div className="bg-gradient-to-br from-plum-50 to-peach-50 border-2 border-plum-200 rounded-xl p-4">
            <label className="flex items-start space-x-3 cursor-pointer">
              <input
                type="checkbox"
                checked={onboardingData.isIrregular}
                onChange={(e) => setOnboardingData({...onboardingData, isIrregular: e.target.checked})}
                className="mt-1 h-5 w-5 text-plum-700 rounded focus:ring-peach-400 border-plum-300"
              />
              <div>
                <p className="font-semibold text-plum-900">My cycle is irregular</p>
                <p className="text-sm text-plum-500">We'll use wider prediction windows and focus on symptoms</p>
              </div>
            </label>
          </div>
        </div>
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="flex-1 bg-plum-900 text-white py-3 rounded-xl font-semibold hover:bg-plum-800 hover:shadow-xl transition"
          >
            Complete Setup
          </button>
        </div>
  ...
  const LogView = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 pb-32" style={{fontFamily: 'Lexend, sans-serif'}}>
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-plum-100">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent">
              🌙 miriam
            </h1>
            <button
              onClick={() => setCurrentView('about')}
              className="text-peach-600 hover:text-peach-700 text-sm font-semibold transition"
            >
              About
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          <div className="bg-white rounded-3xl p-6 shadow-md border border-plum-100 space-y-6">
            {existingLog && (
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                <p className="text-sm text-emerald-800">You've already logged today. Update your entries below.</p>
              </div>
            )}

            <div>
              <label className="block text-sm font-semibold text-plum-900 mb-2">
                Hours of Sleep
              </label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-plum-900 mb-3">
                Mood
              </label>
                ...
                {['poor', 'okay', 'good', 'great'].map((mood) => (
                  <button
                    ...
                    className={`py-3 px-4 rounded-xl font-medium capitalize transition ${
                      todayLog.mood === mood
                        ? 'bg-plum-900 text-white shadow-lg'
                        : 'bg-plum-50 text-plum-700 hover:bg-plum-100 border border-plum-200'
                    }`}
                  >
                    {mood}
                  </button>
            ...
            <div className="h-px bg-plum-100"></div>
          </div>

          <button
            onClick={saveTodayLog}
            disabled={!todayLog.sleep || !todayLog.mood || !todayLog.energy || !todayLog.stress}
            className="w-full bg-peach-400 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-peach-500 hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
          ...
          <button
            ...
            className="w-full bg-plum-50 text-plum-700 py-3 rounded-xl font-semibold hover:bg-plum-100 transition border border-plum-200"
          >
            Cancel
          </button>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 pb-32" style={{fontFamily: 'Lexend, sans-serif'}}>
        ...
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-plum-100">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <button
              onClick={() => setCurrentView('today')}
              className="text-peach-600 hover:text-peach-700 text-sm font-semibold"
            >
              Close
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          {/* Main Content */}
          <div className="bg-white rounded-3xl p-8 shadow-md border border-plum-100 space-y-6">
            <div className="text-center">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent mb-2">
                Your Cycle Guide
              </h2>
              <p className="text-lg text-plum-500 italic">
            ...
            <div className="space-y-4 text-plum-700 leading-relaxed">
              <p>
            ...
            <div className="bg-gradient-to-br from-plum-50 to-peach-50 rounded-xl p-6 border border-plum-200">
              <h3 className="font-bold text-plum-900 mb-3">A note on privacy</h3>
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-plum-100 shadow-lg">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <div className="flex justify-between items-center gap-2">
              <button
                onClick={() => setCurrentView('today')}
                className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition"
              >
  ...
  const MeView = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 pb-32" style={{fontFamily: 'Lexend, sans-serif'}}>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          {/* Data Stats */}
          <div className="bg-white rounded-3xl p-6 shadow-md border border-plum-100">
            <h2 className="text-lg font-bold text-plum-900 mb-4">Your Progress</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-plum-50 to-peach-50 rounded-xl border-l-4 border-peach-400">
                <div>
                  <p className="text-sm text-plum-500">Current Streak</p>
                  <p className="text-2xl font-bold text-plum-900">{streak} days</p>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 bg-plum-50 rounded-xl border border-plum-100">
                  <p className="text-sm text-plum-500 mb-1">Days Logged</p>
                  <p className="text-2xl font-bold text-plum-900">{daysLogged}</p>
                </div>
                <div className="p-4 bg-peach-50 rounded-xl border border-peach-100">
                  <p className="text-sm text-plum-500 mb-1">Cycles Tracked</p>
                  <p className="text-2xl font-bold text-plum-900">{cyclesTracked}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-md border border-plum-100">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-plum-900">Your Profile</h2>
              {!isEditingProfile && (
                <button
                  onClick={startEditingProfile}
                  className="text-sm text-peach-600 hover:text-peach-700 font-semibold"
                >
                  Edit
                </button>
              )}
            ...
            {!isEditingProfile ? (
              <div className="space-y-2 text-sm">
                <div className="flex justify-between py-2 border-b border-plum-50">
                  <span className="text-plum-500">Cycle Length</span>
                  <span className="font-semibold text-plum-900">{userData.profile.averageCycleLength} days</span>
                </div>
                <div className="flex justify-between py-2 border-b border-plum-50">
                  <span className="text-plum-500">Period Length</span>
                  <span className="font-semibold text-plum-900">{userData.profile.averagePeriodLength} days</span>
                </div>
                <div className="flex justify-between py-2 border-b border-plum-50">
                  <span className="text-plum-500">Last Period Start</span>
                  <span className="font-semibold text-plum-900">{new Date(userData.profile.lastPeriodStart).toLocaleDateString()}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-plum-50">
                  <span className="text-plum-500">Last Period End</span>
                  <span className="font-semibold text-plum-900">{new Date(userData.profile.lastPeriodEnd).toLocaleDateString()}</span>
                </div>
                <div className="flex justify-between py-2">
                  <span className="text-plum-500">Irregular Cycle</span>
                  <span className="font-semibold text-plum-900">{userData.profile.isIrregular ? 'Yes' : 'No'}</span>
                </div>
              </div>
            ) : (
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-plum-900 mb-2">Last Period Start</label>
                  <input type="date" value={editedProfile.lastPeriodStart} onChange={(e) => setEditedProfile({...editedProfile, lastPeriodStart: e.target.value})} max={new Date().toISOString().split('T')[0]} className="w-full px-4 py-2 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-plum-900 mb-2">Last Period End</label>
                  <input type="date" value={editedProfile.lastPeriodEnd} onChange={(e) => setEditedProfile({...editedProfile, lastPeriodEnd: e.target.value})} min={editedProfile.lastPeriodStart} max={new Date().toISOString().split('T')[0]} className="w-full px-4 py-2 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-plum-900 mb-2">Average Cycle Length (days)</label>
                  <input type="number" value={editedProfile.averageCycleLength} onChange={(e) => setEditedProfile({...editedProfile, averageCycleLength: parseInt(e.target.value)})} min="21" max="45" className="w-full px-4 py-2 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-plum-900 mb-2">Average Period Length (days)</label>
                  <input type="number" value={editedProfile.averagePeriodLength} onChange={(e) => setEditedProfile({...editedProfile, averagePeriodLength: parseInt(e.target.value)})} min="1" max="10" className="w-full px-4 py-2 border-2 border-plum-200 rounded-xl focus:border-peach-400 focus:ring-2 focus:ring-peach-100 focus:outline-none" />
                </div>
                <div className="bg-plum-50 rounded-xl p-4 border border-plum-200">
                  <label className="flex items-start space-x-3 cursor-pointer">
                    <input type="checkbox" checked={editedProfile.isIrregular} onChange={(e) => setEditedProfile({...editedProfile, isIrregular: e.target.checked})} className="mt-1 h-5 w-5 text-plum-700 rounded focus:ring-peach-400 border-plum-300" />
                    <div>
                      <p className="font-semibold text-plum-900">My cycle is irregular</p>
                      <p className="text-sm text-plum-500">Cycles vary by more than 7 days</p>
                    </div>
                  </label>
                </div>
                <div className="flex space-x-3 pt-2">
                  <button onClick={() => setIsEditingProfile(false)} className="flex-1 bg-plum-50 text-plum-700 py-3 rounded-xl font-semibold hover:bg-plum-100 transition">Cancel</button>
                  <button onClick={saveProfileEdits} className="flex-1 bg-plum-900 text-white py-3 rounded-xl font-semibold hover:bg-plum-800 hover:shadow-xl transition">Save Changes</button>
                </div>
              </div>
            )}
          </div>
          ...
          {/* Privacy */}
          <div className="bg-gradient-to-br from-plum-50 to-peach-50 rounded-3xl p-6 shadow-md border-2 border-plum-200">
            <div className="pl-4 border-l-2 border-plum-400">
              <h3 className="font-bold text-plum-900 mb-2">Your Data is Private</h3>
              <p className="text-sm text-plum-700 leading-relaxed">
          ...
          {/* Data Management */}
          <div className="bg-white rounded-3xl p-6 shadow-md border border-plum-100 space-y-4">
            <h2 className="text-lg font-bold text-plum-900">Data Management</h2>

            <div className="space-y-3">
              <button
                onClick={exportData}
                className="w-full flex items-center justify-between p-4 bg-plum-50 hover:bg-plum-100 rounded-xl border border-plum-200 transition"
              >
                <div className="text-left">
                  <p className="font-semibold text-plum-900">Export Data</p>
                  <p className="text-xs text-plum-500">Download a backup file</p>
                </div>
                <span className="text-peach-600">→</span>
              </button>

              <label className="w-full flex items-center justify-between p-4 bg-plum-50 hover:bg-plum-100 rounded-xl border border-plum-200 transition cursor-pointer">
                <div className="text-left">
                  <p className="font-semibold text-plum-900">Import Data</p>
                  <p className="text-xs text-plum-500">Restore from a backup file</p>
                </div>
                <span className="text-peach-600">→</span>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-plum-100 shadow-lg">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <div className="flex justify-between items-center gap-2">
              <button onClick={() => setCurrentView('today')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition">
                <span className="text-xs font-medium mt-1">Today</span>
              </button>
              <button onClick={() => setCurrentView('cycle')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition">
                <span className="text-xs font-medium mt-1">Cycle</span>
              </button>
              <button onClick={() => setCurrentView('log')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition">
                <span className="text-xs font-medium mt-1">Log</span>
              </button>
              <button onClick={() => { setCurrentView('learn'); setLearnPhase(null); }} className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition">
                <span className="text-xs font-medium mt-1">Learn</span>
              </button>
              <button onClick={() => setCurrentView('me')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-peach-600 bg-peach-50">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 pb-32" style={{fontFamily: 'Lexend, sans-serif'}}>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-md border border-plum-100" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
            <h3 className="font-bold text-plum-900 mb-3 text-xs">Cycle Phases</h3>
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 rounded" style={{backgroundColor: '#7B4392'}}></div>
                <p className="text-[10px] text-plum-700">Menstrual (1-{userData.profile.averagePeriodLength})</p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 rounded" style={{backgroundColor: '#FFDAB9'}}></div>
                <p className="text-[10px] text-plum-700">Follicular ({userData.profile.averagePeriodLength + 1}-13)</p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 rounded" style={{backgroundColor: '#E08C34'}}></div>
                <p className="text-[10px] text-plum-700">Ovulatory (14-16)</p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 rounded" style={{backgroundColor: '#E9D8E6'}}></div>
                <p className="text-[10px] text-plum-700">Early Luteal (17-23)</p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 rounded" style={{backgroundColor: '#D4B5D0'}}></div>
                <p className="text-[10px] text-plum-700">Late Luteal (24-{userData.profile.averageCycleLength})</p>
              </div>
            </div>
          </div>

          {/* Calendar Grid */}
          <div className="bg-white rounded-2xl p-5 shadow-md border border-plum-100" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
            <div className="grid grid-cols-7 gap-2">
              {cycleDays.map((day) => {
                ...
                const textColor = (day.phase === 'menstrual' || day.phase === 'ovulatory') ? '#FFFFFF' : '#362051';
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${day.isToday ? 'ring-4 ring-peach-400 shadow-xl scale-105' : 'shadow-md'}
                  ...
                  >
                    ...
                    {day.isToday && (
                      <div className="absolute -top-1 -right-1 bg-peach-600 text-white text-[10px] px-2 py-0.5 rounded-full font-bold">
                        NOW
                      </div>
                    )}
                  </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-plum-100 shadow-lg">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <div className="flex justify-between items-center gap-2">
              ...
              <button onClick={() => setCurrentView('cycle')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-peach-600 bg-peach-50">
              ...
              <button onClick={() => setCurrentView('me')} className="flex-1 flex flex-col items-center py-2 rounded-lg text-plum-400 hover:text-peach-600 hover:bg-peach-50 transition">
                <span className="text-xs font-medium mt-1">Me</span>
              </button>
            </div>
          </div>
  ...
  const TodayView = () => {
    ...
    const phaseToMoon = {
      'Menstrual': 'new', 'Follicular': 'waxingCrescent', 'Ovulatory': 'full',
      'Early Luteal': 'waningGibbous', 'Late Luteal': 'lastQuarter', 'Luteal': 'waningGibbous'
    };

    const GuidanceCard = ({ title, category, data }) => (
      <div className="bg-white rounded-2xl p-5 shadow-md border border-plum-100 hover:shadow-lg transition">
        <h4 className="font-bold text-lg text-plum-900 tracking-tight">{title}</h4>
        <p className="text-plum-700 mt-2 leading-relaxed">
          {data.message}
        </p>
        {data.modifier && (
          <p className="text-peach-700 mt-2 text-sm bg-peach-50 rounded-lg p-3 border border-peach-200">
            <strong>Why:</strong> {data.modifier}
          </p>
        )}
        <button
          onClick={() => setExpandedCard(expandedCard === category ? null : category)}
          className="text-peach-600 hover:text-peach-700 text-sm font-medium mt-3 flex items-center space-x-1"
        >
          <span>{expandedCard === category ? '▼' : '▶'}</span>
          <span>{expandedCard === category ? 'Hide' : 'Why this matters'}</span>
        </button>
        {expandedCard === category && (
          <div className="mt-3 bg-plum-50 rounded-xl p-4 space-y-2 border border-plum-100">
            <p className="text-sm text-plum-900">
              <strong>The Science:</strong> {data.science}
            </p>
            {data.suggestions && (
              <div className="mt-2">
                <p className="text-sm font-semibold text-plum-900 mb-1">Try:</p>
                <div className="flex flex-wrap gap-2">
                  {data.suggestions.map((suggestion, idx) => (
                    <span key={idx} className="text-xs bg-white text-plum-700 px-3 py-1 rounded-full border border-plum-200">
                      {suggestion}
                    </span>
                  ))}
                </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100" style={{fontFamily: 'Lexend, sans-serif'}}>
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-plum-100">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent">
              🌙 miriam
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6 pb-32">
          <div className={`bg-gradient-to-r ${phaseInfo.phaseColor} rounded-3xl p-8 text-white shadow-xl`}>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-6xl">{moonEmojis[phaseToMoon[phaseInfo.phase]]}</span>
              </div>
            </div>
          </div>

          {!todayData ? (
            <div className="bg-peach-50 border-2 border-peach-200 rounded-2xl p-4">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-plum-900">Today's Guidance</h3>

            <div className="space-y-4">
              <GuidanceCard title="Training" category="training" data={guidance.training} />
              <GuidanceCard title="Nutrition" category="nutrition" data={guidance.nutrition} />
              <GuidanceCard title="Energy & Social" category="energy" data={guidance.energy} />
              <GuidanceCard title="Meal Times" category="fasting" data={guidance.fasting} />
            </div>
          </div>

          <button
            onClick={() => setCurrentView('log')}
            className="w-full bg-peach-400 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-peach-500 hover:shadow-xl transform hover:scale-105 transition-all"
          >
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-plum-100 shadow-lg">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <div className="flex justify-between items-center gap-2">
              <button onClick={() => setCurrentView('today')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${currentView === 'today' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
                <span className="text-xs font-semibold mt-1">Today</span>
              </button>
              <button onClick={() => setCurrentView('cycle')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${currentView === 'cycle' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
                <span className="text-xs font-medium mt-1">Cycle</span>
              </button>
              <button onClick={() => setCurrentView('log')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${currentView === 'log' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
                <span className="text-xs font-medium mt-1">Log</span>
              </button>
              <button onClick={() => { setCurrentView('learn'); setLearnPhase(null); }} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${currentView === 'learn' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
                <span className="text-xs font-medium mt-1">Learn</span>
              </button>
              <button onClick={() => setCurrentView('me')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${currentView === 'me' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
                <span className="text-xs font-medium mt-1">Me</span>
              </button>
            </div>
          </div>
  ...
  const BottomNav = ({ active }) => (
    <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-plum-100 shadow-lg">
      <div className="max-w-4xl mx-auto px-4 py-3">
        <div className="flex justify-between items-center gap-2">
          <button onClick={() => setCurrentView('today')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${active === 'today' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
            <span className={`text-xs ${active === 'today' ? 'font-semibold' : 'font-medium'} mt-1`}>Today</span>
          </button>
          <button onClick={() => setCurrentView('cycle')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${active === 'cycle' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
            <span className={`text-xs ${active === 'cycle' ? 'font-semibold' : 'font-medium'} mt-1`}>Cycle</span>
          </button>
          <button onClick={() => setCurrentView('log')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${active === 'log' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
            <span className={`text-xs ${active === 'log' ? 'font-semibold' : 'font-medium'} mt-1`}>Log</span>
          </button>
          <button onClick={() => { setCurrentView('learn'); setLearnPhase(null); }} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${active === 'learn' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
            <span className={`text-xs ${active === 'learn' ? 'font-semibold' : 'font-medium'} mt-1`}>Learn</span>
          </button>
          <button onClick={() => setCurrentView('me')} className={`flex-1 flex flex-col items-center py-2 rounded-lg transition ${active === 'me' ? 'text-peach-600 bg-peach-50' : 'text-plum-400 hover:text-peach-600 hover:bg-peach-50'}`}>
  ...
  const LearnView = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-plum-50 via-peach-50 to-plum-100 pb-28" style={{fontFamily: 'Lexend, sans-serif'}}>
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-plum-100">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent">
              🌙 miriam
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-plum-900 to-plum-700 bg-clip-text text-transparent">Learn</h2>
            <p className="text-plum-500">Understand your cycle, phase by phase</p>
          </div>
            ...
            {phases.map((phaseName) => {
              ...
              return (
                <button
                  ...
                  className={`w-full ${guide.cardBg} rounded-3xl p-6 shadow-md border border-plum-100 text-left hover:shadow-lg transition-all hover:scale-[1.02]`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4 flex-1">
                      <span className="text-4xl">{moonEmojis[guide.icon]}</span>
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-plum-900">{guide.title}</h3>
                        <p className="text-sm text-peach-600 font-medium">{guide.subtitle}</p>
                        <p className="text-xs text-plum-400 mt-1">{guide.days}</p>
                      </div>
                    </div>
                    <span className="text-plum-400 text-xl ml-2">›</span>
                  </div>
                </button>
              );
            })}
        ...
        <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-plum-100">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <button
              ...
              className="text-peach-600 hover:text-peach-700 font-semibold transition flex items-center space-x-1"
            >
              <span>←</span>
              <span>Back</span>
            </button>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
          ...
          <div className={`bg-gradient-to-r ${guide.color} rounded-3xl p-8 text-white shadow-xl`}>
            <div className="flex items-center justify-between">
              ...
              <span className="text-6xl">{moonEmojis[guide.icon]}</span>
            </div>
          </div>

          {/* Overview */}
          <div className="bg-white rounded-3xl p-6 shadow-md border border-plum-100">
            <h3 className="text-lg font-bold text-plum-900 mb-3">Overview</h3>
            <p className="text-plum-700 leading-relaxed">{guide.overview}</p>
          </div>

          {/* Sections */}
          {guide.sections.map((section, index) => (
            <div key={index} className="bg-white rounded-3xl shadow-md border border-plum-100 overflow-hidden">
              <div className="p-6">
                <h4 className="text-lg font-bold text-plum-900 mb-3">{section.title}</h4>
                <p className="text-plum-700 leading-relaxed whitespace-pre-line">{section.summary}</p>

                <button
                  onClick={() => toggleSection(index)}
                  className="text-peach-600 hover:text-peach-700 text-sm font-medium mt-4 flex items-center space-x-1"
                >
                ...
                {expandedSections.includes(index) && (
                  <div className="mt-4 bg-plum-50 rounded-xl p-4 space-y-3 border border-plum-100">
                    <p className="text-sm text-plum-900 leading-relaxed whitespace-pre-line">{section.details}</p>
                    {section.suggestions && section.suggestions.length > 0 && (
                      <div>
                        <p className="text-sm font-semibold text-plum-900 mb-2">Try:</p>
                        <div className="flex flex-wrap gap-2">
                          {section.suggestions.map((suggestion, idx) => (
                            <span key={idx} className="bg-white text-plum-700 px-3 py-1 rounded-xl text-sm border border-plum-200">
                              {suggestion}
                            </span>
                          ))}
                        </div>
          ...
          {/* Key Takeaways */}
          <div className="bg-gradient-to-br from-plum-50 to-peach-50 rounded-3xl p-6 shadow-md border border-plum-200">
            <h3 className="text-lg font-bold text-plum-900 mb-4">Key Takeaways</h3>
            <ul className="space-y-3">
              {guide.keyTakeaways.map((takeaway, idx) => (
                <li key={idx} className="flex items-start space-x-3">
                  <span className="text-peach-600 mt-0.5">✓</span>
                  <span className="text-plum-900">{takeaway}</span>
                </li>
              ))}
            </ul>
          </div>
